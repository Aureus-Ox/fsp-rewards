...
if __name__ == '__main__':
    ...
    reward_manager_contract_address = web3.to_checksum_address('0xC8f55c5aA2C752eE285Bd872855C749f4ee6239B')
    reward_manager_contract = web3.eth.contract(address=reward_manager_contract_address,
                                                        abi=reward_manager_abi)

    entity_address = web3.to_checksum_address('0xE3b7968c1B706461A8f63540080ECF4Ce70C30c0')
